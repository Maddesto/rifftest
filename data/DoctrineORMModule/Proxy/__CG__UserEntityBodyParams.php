 ...
 */
class BodyParams extends \User\Entity\BodyParams implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'user_id', 'breast', 'waist', 'hips', 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BodyParams $proxy) {
